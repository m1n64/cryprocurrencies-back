...
namespace Modules\Coincap\Facades {
     ...
     */        class Coincap {
         ...
         * @return array 
         * @static 
         */        public static function request($path, $method = 'GET', $data = [])
        {            //Method inherited from \Modules\Coincap\Services\Core\AbstractCoincapCore         
                        /** @var \Modules\Coincap\Services\CoincapService $instance */
                        return $instance->request($path, $method, $data);
        }
                    /**
         * 
         *
         ...
         *
         * @param string $code
         * @param \Modules\Coincap\Services\HistoryIntervalEnum $interval
         * @return array 
         * @static 
         */        public static function assetsHistory($code, $interval = \Modules\Coincap\Enums\HistoryIntervalEnum::DAY)
        {
                        /** @var \Modules\Coincap\Services\CoincapService $instance */
                        return $instance->assetsHistory($code, $interval);
        }
            }
    }
...
namespace  {
            ...
            class Coincap extends \Modules\Coincap\Facades\Coincap {}
    }
